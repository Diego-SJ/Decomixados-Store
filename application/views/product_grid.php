                ...
                <div class="bar-wrap">
                    <div class="container">
                        <div class="row">
                            <div class="span12">
                                <div class="title-bar">
                                    <h1><?php if(!empty($category)){echo ucwords($category->name);} else {echo "Oh oh!";} ?></h1>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="span12">
                                <div class="sorting-bar clearfix">
                                    <div>
                                        ...
                                        action="<?php echo base_url().'category/detail/'.$category->idcategories; ?>">
                                    ...
                                    <label>Mostrando <?php if(!empty($total_products)){echo $total_products->total;} else {echo "0";} ?> p.</label>
                                    </div>
                                </div>
                            </div>
                        </div>
